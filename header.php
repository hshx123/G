...
<head>
	...
	<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5087880679666588"
    crossorigin="anonymous"></script>

	<meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=0, width=device-width"/>
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<!-- DNS预解析 -->
	<link rel="dns-prefetch" href="//s1.502.chat">

	<title><?php $this->archiveTitle(' &raquo; ', '', ' | '); ?><?php $this->options->title(); ?></title>

	<script src="https://s1.502.chat/G/JS/jquery.min.js"></script>
	...
	<link rel="stylesheet" href="https://s1.502.chat/G/CSS/OwO.min.css" rel="stylesheet" />
	<link rel="stylesheet" href="https://s1.502.chat/G/CSS/prism.css" rel="stylesheet" />
	<?php if ($this->options->enablenprogress == 1): ?>
		<link rel='stylesheet' href="https://s1.502.chat/G/CSS/nprogress.css" rel="stylesheet" />
	<?php endif; ?>
	<link href="https://s1.502.chat/G/CSS/jquery.fancybox.min.css" rel="stylesheet">
	<script src="https://s1.502.chat/G/JS/DPlayer.min.js"></script>
	<link rel="stylesheet" href="https://s1.502.chat/G/CSS/katex.min.css" integrity="sha384-Um5gpz1odJg5Z4HAmzPtgZKdTBHZdw8S29IecapCSB31ligYPhHQZMIlWLYQGVoc" crossorigin="anonymous">
	<script defer src="https://s1.502.chat/G/JS/katex.min.js" integrity="sha384-YNHdsYkH6gMx9y3mRkmcJ2mFUjTd0qNQQvY9VYZgQd7DcN7env35GzlmFaZ23JGp" crossorigin="anonymous"></script>
	<script defer src="https://s1.502.chat/G/JS/auto-render.min.js" integrity="sha384-vZTG03m+2yp6N6BNi5iM4rW4oIwk5DfcNdFfxkk9ZWpDriOkXX8voJBFrAO7MpVl" crossorigin="anonymous"></script>
		...
		<div id="header">
            ...
            <?php while($pages->next()): ?>
            		...
            		<a class="<?php if($this->is('page', $pages->slug)): ?> nav-focus<?php endif; ?>" href="<?php $pages->permalink(); ?>" title="<?php $pages->title(); ?>"><?php $pages->title(); ?></a>
						...
						<a href="<?php Helper::options()->siteUrl()?>category/H">H！</a>
